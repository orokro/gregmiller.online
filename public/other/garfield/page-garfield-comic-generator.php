...
<?
	...
	if(isset($_GET['cid']) && $_GET['cid']!=''){
		...
		$comicLink = 'http://www.gmiller.net/garfield-comic-generator/?cid=' . $frames[0].'-'.$frames[1].'-'.$frames[2].'-'.$frames[3];
		$preSet=true;
	}
...
<body>
    ...
    <script type="text/javascript">
		...
		function generate_comic(){
			...
			txtLink.value = ('http://www.gmiller.net/garfield-comic-generator/?cid=' + topic + '-' + frameA + '-' + frameB + '-' + frameC);
